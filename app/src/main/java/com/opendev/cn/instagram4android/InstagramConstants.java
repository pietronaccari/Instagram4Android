...
public class InstagramConstants {
    ...
    public static final String DEVICE_MODEL = "ginkgo";

    //public static final String DEVICE_ANDROID_VERSION = "23";
    public static final String DEVICE_ANDROID_VERSION = "30";

    //public static final String DEVICE_ANDROID_RELEASE = "6.0.1";
    public static final String DEVICE_ANDROID_RELEASE = "11";
    ...
    //public static final String USER_AGENT = String.format("Instagram 10.21.0 Android (%s/%s; 640dpi; 1440x2560; %s; %s; hero2lte; samsungexynos8890; en_US)",
    //DEVICE_ANDROID_VERSION, DEVICE_ANDROID_RELEASE, DEVICE_MANUFACTURER, DEVICE_MODEL);

    //Android (30/11; 440dpi; 1080x2130; Xiaomi/xiaomi; Redmi Note 8; ginkgo; qcom; pt_BR; 384108453)
    public static final String USER_AGENT = String.format("Instagram 244.1.0.19.110 Android (%s/%s; 640dpi; 1440x2560; %s; %s; Xiaomi/xiaomi; ginkgo; it_IT)", DEVICE_ANDROID_VERSION, DEVICE_ANDROID_RELEASE, DEVICE_MANUFACTURER, DEVICE_MODEL);
}
